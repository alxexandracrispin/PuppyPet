...
VALUES
-- PERROS
('PER001', 'Dog Chow Adulto 3kg', 'Alimento balanceado para perros adultos.', 11490, 20, '/assets/images/dogchow3.png', 1),
('PER002', 'Pedigree Cachorro 3kg', 'Ideal para crecimiento saludable.', 14990, 18, '/assets/images/pedi3.png', 1),
('PER003', 'Royal Canin Mini 3kg', 'Especial para razas pequeñas.', 24990, 12, '/assets/images/royal3.png', 1),
('PER004', 'Dog Chow Adulto 8kg', 'Alimento balanceado para perros adultos.', 22990, 16, '/assets/images/dogchow8.png', 1),
('PER005', 'Pedigree Cachorro 8kg', 'Ideal para crecimiento saludable.', 24990, 15, '/assets/images/pedi8.png', 1),
('PER006', 'Royal Canin Mini 8kg', 'Especial para razas pequeñas.', 34990, 10, '/assets/images/royal8.png', 1),
('PER007', 'Dog Chow Adulto 15kg', 'Alimento balanceado para perros adultos.', 32990, 14, '/assets/images/dogchow15.png', 1),
('PER008', 'Pedigree Cachorro 15kg', 'Ideal para crecimiento saludable.', 34990, 12, '/assets/images/pedi15.png', 1),
('PER009', 'Royal Canin Mini 15kg', 'Especial para razas pequeñas.', 44990, 8, '/assets/images/royal15.png', 1),

-- GATOS
('GAT001', 'Whiskas Adulto 3kg', 'Alimento balanceado para gatos adultos.', 10990, 22, '/assets/images/wisk3.png', 2),
('GAT002', 'Cat Chow 3kg', 'Nutrición completa para gatos activos.', 11990, 20, '/assets/images/catsh3.png', 2),
('GAT003', 'Royal Canin Indoor 3kg', 'Ideal para gatos de interior.', 22990, 12, '/assets/images/royalgato3.png', 2),
('GAT004', 'Whiskas Adulto 8kg', 'Formato ahorro.', 19990, 18, '/assets/images/wisk8.png', 2),
('GAT005', 'Cat Chow 8kg', 'Alta digestibilidad.', 21990, 16, '/assets/images/catsh8.png', 2),
('GAT006', 'Royal Canin Indoor 8kg', 'Nutrición premium.', 39990, 10, '/assets/images/royalgato8.png', 2),
('GAT007', 'Whiskas Adulto 15kg', 'Formato ahorro.', 29990, 12, '/assets/images/wisk15.png', 2),
('GAT008', 'Cat Chow 15kg', 'Alta digestibilidad.', 31990, 10, '/assets/images/catsh15.png', 2),
('GAT009', 'Royal Canin Indoor 15kg', 'Nutrición premium.', 49990, 8, '/assets/images/royalgato15.png', 2),
