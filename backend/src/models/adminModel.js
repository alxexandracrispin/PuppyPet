...
// Todas las consultas de este modelo leen desde el modelo estrella (hecho_venta + dimensiones),
// no desde las tablas operacionales, lo que permite respuestas más rápidas para el dashboard
const AdminModel = {

  // Obtiene los KPIs principales del negocio desde la tabla de hechos.
  // IFNULL evita que retorne NULL cuando no hay ventas registradas
  ...
  // Obtiene el ranking de los 10 productos más vendidos por cantidad de unidades
  ...
  // Obtiene el total de ventas agrupadas por mes para mostrar la tendencia en el gráfico
  ...
  // Obtiene el total de ventas segmentado por tipo de cliente (registrado vs invitado)
