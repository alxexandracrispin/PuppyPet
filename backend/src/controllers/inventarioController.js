...
const InventarioController = {
  ...
  // Retorna todos los productos activos con su estado de semáforo (ROJO/AMARILLO/VERDE)
  ...
  // Retorna el historial completo de movimientos de inventario
  ...
  // Valida y delega el registro de un movimiento al modelo.
  // Verifica que el tipo sea ENTRADA o SALIDA y que la cantidad sea positiva antes de continuar
  ...
  // Actualiza los umbrales del semáforo de stock de un producto.
  // Valida que stock_crítico < stock_alerta para que el semáforo tenga sentido lógico
  actualizarUmbralesStock: (req, res) => {
    ...
    if (stockCritico === undefined || stockAlerta === undefined) {
      return res.status(400).json({
